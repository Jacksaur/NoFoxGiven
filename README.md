...
# Known issues
The version of Firefox that is downloaded and installed only applies to the current user, whilst the Snap removal commands affect the whole system. This means that other Users on the system will be left without a browser, and will need to install their own afterwards.
